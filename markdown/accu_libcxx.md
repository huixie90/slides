...
## `std::expected` Implementation 1 Layout
...
## `std::expected` Implementation 2 Layout
...
- <!-- .element: class="fragment" -->
  MSVC ignores `[[no_unique_address]]` for ABI reasons
...
class expected {
  ...
  public:
    expected(const expected& other) {
        ...
        has_val = other.has_val_;
    }
};
```

It solves this issue, but is it enough?
<!-- .element: class="fragment" -->
